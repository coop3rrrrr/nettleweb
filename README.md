...
[Main Link](https://Limitl3ss.com/) | [Wiki](../../wiki) | [Links](../../wiki/Mirror-Links) | [Discord](https://discord.gg/djdH3kVd4v)

## About
Limitl3ss is a free, open-source unblocked online community platform that allows users to chat, watch videos and share games. Its goal is to bring every internet user an unrestricted and private environment, because we believe that it is incorrect to steal user data without their proper consent, and everyone deserves the right to do whatever they want.

Limitl3ss is, and will always be, free and open-source. You can however show us your care by giving a star or contributing to this project (see the contributing section below for details). It will significantly improve the project's future development.
...
## Issues & Support
If you have issues and would like to get a support, you can contact the developers on the [website](https://Limitl3ss.com/@anonymous). You will need a registered account to do so in order to prevent bot overloading, and it is strongly recommended to use your personal device.

## Contributing
If you are a developer and wish Limitl3ss to become better, please consider contributing to this project. This can be done by simply
...
- [Limitl3ss Core](https://github.com/Limitl3ss/Limitl3ss-core)
